...
public class Interpreter {
    public static void main(String[] args) {
        ...
        IStmt ex1 = new CompStmt(new VarDeclStmt("v", new IntType()), new CompStmt(new AssignStmt("v", new ValueExpr(new BoolValue(false))), new PrintStmt(new VarExpr("v"))));
        try {
        ...
        try {
            ...
            System.out.println("Typecheck error in while example example: " + e.getMessage());
        }
        ...
        try {
            ...
            System.out.println("Typecheck error in fork example example: " + e.getMessage());
        }
...
//            menu.addCommand(new RunExample("11", "Run Fork example.", ctrlFork));
